...
<body>
	...
	<form action="${pageContext.request.contextPath }/insertQuestionnaire.action" method="post">
		<div>
			<div>
				<input type="text" name="designTempletName" value=${dictTempletName } id="designTempletName" placeholder="请输入字典模板名称">
			</div>
			<br />
			<br />
			<br />
					...
					<table border="1px" align="center" id="table_single">
						...
						<c:forEach varStatus="i" var="dictSingle" items="${dictSingleList }">
							<tr id="single${i.count }">
								...
								<td>
									<a onclick="delete_single(this)">删除</a>
								</td>
							</tr>
						</c:forEach>
					</table>
					...
					<table border="1px" align="center" id="table_check">
						...
						<c:forEach varStatus="i" var="dictCheckbox" items="${dictCheckboxList }">
							<tr id="check${i.count }">
								...
								<td>
									<a onclick="delete_check(this)">删除</a>
								</td>
							</tr>
						</c:forEach>
					</table>
					...
					<table border="1px" align="center" id="table_text">
						...
						<c:forEach varStatus="i" var="dictText" items="${dictTextList }">
							<tr id="text${i.count }">
								...
								<td>
									<a onclick="delete_text(this)">删除</a>
								</td>
							</tr>
						</c:forEach>
					</table>
